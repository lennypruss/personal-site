...
const blogPosts = [
  { title: 'The primitive is the product', url: 'https://www.amplifypartners.com/blog-posts/the-primitive-is-the-product', date: 'Jun 2026' },
...
const investments = [
  ...
  { name: 'Superlogical', url: 'https://superlogical.com', logo: '/logos/superlogical.png', logoStyle: { width: 96, height: 'auto' } },
